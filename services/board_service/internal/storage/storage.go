...
type storage struct {
	db           *sql.DB
	cardsStorage cardsStorage.Storage
	tasksStorage tasksStorage.Storage
}

func NewStorage(db *sql.DB, cardsStorage cardsStorage.Storage, tasksStorage tasksStorage.Storage) Storage {
	return &storage{
		db: db,
