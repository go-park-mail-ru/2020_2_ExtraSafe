...
func easyjson74fcd6ebDecodeGithubComGoParkMailRu20202ExtraSafeInternalModels2(in *jlexer.Lexer, out *BoardMemberInput) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson74fcd6ebEncodeGithubComGoParkMailRu20202ExtraSafeInternalModels2(out *jwriter.Writer, in BoardMemberInput) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson74fcd6ebDecodeGithubComGoParkMailRu20202ExtraSafeInternalModels3(in *jlexer.Lexer, out *BoardMember) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson74fcd6ebEncodeGithubComGoParkMailRu20202ExtraSafeInternalModels3(out *jwriter.Writer, in BoardMember) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson74fcd6ebDecodeGithubComGoParkMailRu20202ExtraSafeInternalModels4(in *jlexer.Lexer, out *BoardInviteInput) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson74fcd6ebEncodeGithubComGoParkMailRu20202ExtraSafeInternalModels4(out *jwriter.Writer, in BoardInviteInput) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson74fcd6ebDecodeGithubComGoParkMailRu20202ExtraSafeInternalModels5(in *jlexer.Lexer, out *BoardInternal) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson74fcd6ebEncodeGithubComGoParkMailRu20202ExtraSafeInternalModels5(out *jwriter.Writer, in BoardInternal) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson74fcd6ebDecodeGithubComGoParkMailRu20202ExtraSafeInternalModels6(in *jlexer.Lexer, out *BoardInput) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson74fcd6ebEncodeGithubComGoParkMailRu20202ExtraSafeInternalModels6(out *jwriter.Writer, in BoardInput) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson74fcd6ebDecodeGithubComGoParkMailRu20202ExtraSafeInternalModels7(in *jlexer.Lexer, out *BoardChangeInput) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson74fcd6ebEncodeGithubComGoParkMailRu20202ExtraSafeInternalModels7(out *jwriter.Writer, in BoardChangeInput) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson74fcd6ebDecodeGithubComGoParkMailRu20202ExtraSafeInternalModels8(in *jlexer.Lexer, out *Board) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson74fcd6ebEncodeGithubComGoParkMailRu20202ExtraSafeInternalModels8(out *jwriter.Writer, in Board) {
	out.RawByte('{')
	first := true
	_ = first
	{
